...
# v1 step run. The shim also arranges for v3-v13 to run after v1 so later systems are
...
# order, ending with v13's locked elemental combat-role overhaul.
...
print('Applied village depth v2 staging shim; v3-v13 queued after v1, including clan specialisations, split Dōjutsu, Genjutsu control and locked elemental combat roles.')
