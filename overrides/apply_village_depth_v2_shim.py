...
# v1 step run. The shim also arranges for v3-v14 to run after v1 so later systems are
...
# order, ending with v13's elemental roles, v13.1's signature fix, then v14's
# progression-purchase reliability audit/hardening pass.
...
print('Applied village depth v2 staging shim; v3-v14 queued after v1, including clan specialisations, split Dōjutsu, Genjutsu control, locked elemental combat roles and progression-purchase reliability hardening.')