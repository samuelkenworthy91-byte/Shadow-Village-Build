...
# v1 step run. The shim also arranges for v3-v13.1 to run after v1 so later systems are
...
# order, ending with v13's elemental roles then v13.1's save-compatible signature fix.
...
print('Applied village depth v2 staging shim; v3-v13.1 queued after v1, including clan specialisations, split Dōjutsu, Genjutsu control, locked elemental combat roles and the save-compatible signature hotfix.')
