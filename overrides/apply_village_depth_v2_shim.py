...
# v1 step run. The shim also arranges for v3-v15 to run after v1 so later systems are
...
# order, ending with v14's purchase audit then v15's frozen-at-unlock dynamic rows.
...
print('Applied village depth v2 staging shim; v3-v15 queued after v1, including clan specialisations, split Dōjutsu, Genjutsu control, locked elemental combat roles, purchase reliability hardening and frozen-at-unlock dynamic technique rows.')