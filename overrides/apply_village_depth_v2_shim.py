...
print('Applied village depth v2 staging shim; v3-v16 queued after v1, including clan specialisations, split Dōjutsu, Genjutsu control, locked elemental combat roles, purchase reliability hardening, frozen-at-unlock dynamic technique rows, exclusive specialist Jutsu identities, stronger rare arts, Techniques/Gear combat submenus and strict TypeScript cleanup.')